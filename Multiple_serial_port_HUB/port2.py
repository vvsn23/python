#!/usr/bin/env python
#
# Redirect data from a TCP/IP connection to a serial port and vice versa through UART
#
# Author : V V Satayanarayana
# Company: Royal Eleganec Tech. Pvt.- Bangalore
# Date   : 08/11/2017
#
# client : RTWO HealthCare
#############################################################################
...
if __name__ == '__main__':  # noqa
    ...
    parser = argparse.ArgumentParser(
        description='Serial to Network (TCP/IP) redirector.',
        epilog="""\

NOTE: Only one connection at once is supported. When the connection is terminated
...
""")
    ...
    if not args.quiet:
	    ...
	    '--- Aggerater Board Port-2 source code \n'
