...
if(!empty($_POST['textp'])){
   ...
   $ff42= "priority=1 \n";
   $ff5="}\n";
   $txt=$txt1 . $txt2 . $txt3 . $ff . $ff3 . $ff4 . $ff41 . $ff5;

   fwrite($myfile, $txt);
   fclose($myfile);

   $wal1 = system('ifup wlan0'); 
   echo $result;
   $wal2 = system('reboot');
   echo $wal2;
...
if(!empty($_POST['textw3'])){
   ...
   $b1="auto wlan1 \n";
   $c="allow-hotplug wlan1 \n";
   $txt1 ="iface wlan1 inet static\n";
   $ff2="pre-up wpa_supplicant -B -i wlan1 -c/etc/wpa_supplicant/wpa_supplicant.conf \n";
   ...
   $txt2q=$txt22 . $ff22 . $txt23 . $a . $b . $b1 . $c .  $txt1 . $ff2 . $txt2  . $ff3 . $txt33.  $txt3 . $ff4 . $txt4 . $ff7;
   ...
   $b2c="auto eth0\n";
   $c2q="allow-hotplug eth0 \n";
   $txt12q ="iface eth0 inet static\n";
   $ff32q="\taddress ".$stru1."\n";
   ...
   $txt22q=$txt222q . $ff222q . $txt232q. $a2q . $b2q .$b2c. $c2q. $cc2q . $ff12q . $txt12q . $ff22q . $txt22q . $ff32q . $txt332q.  $txt32q . $ff42q . $txt42q . $ff72q;
...
<div id='page'>
<div id='title'>
<p style='margin:6px;height:25px;font-size:160%; width:539px;padding-top:-10px;padding:-3px;background-color:	#006599;  float:left;color:white;font-style:oblique;'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;RTWO Health Care</p><br>
</div>

<div id='menu'></div>
<div id='content'>
<div id='status' style='width: 650px; height:550px;background-color:#E6E6E6;'>
<div id='display' style='display: inline;'>
 <h2 style='margin-top:5px;margin-bottom:20px;'> &nbsp;&nbsp;  &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; MULTI PORT SERIAL  HUB SETTINGS</h2>
 <div id='footer'></div>
 <p>
 <form method="post">&nbsp;&nbsp;  &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp; NETWORK MODE &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;  
...
<div id="WIFI(CLIENT)-SERIAL" class="inv2"><p>
  <tr><th>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp SSID &nbsp </th><td><input type="text" name="textu"  id="text1" value="<?php if(isset($stru1)){ echo $stru1;}?>" ></td></tr>
...
<option value="content_1">Static</option>
  ...
  <tr><th> &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp IP &nbsp;</th>
  <td><input name='textw1' maxlength="18" size="11" type='text' value="<?php if(isset($strw1)){ echo $strw1;}?>"></td></tr>
 <tr><th>Sub Net &nbsp;</th><td><input name='textw2' maxlength="18" size="12" type='text'  value="<?php if(isset($strw2)){ echo $strw2;}?>"></td></tr>
  <tr><th>Gate Way &nbsp;</th><td><input name='textw3'  maxlength="18" size="12" type='text' value="<?php if(isset($strw3)){ echo $strw3;}?>"></td></tr>
</p></div>
<script>
            document
...
<table>
  <tr><th>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; CONFIGURED </th></tr><tr></tr><tr></tr><tr></tr><tr></tr>
  
  
  <tr>
    <th>SERIAL PORT1 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
    <td><?php  if(isset($str1)){ echo $str1;}?> </td>
	<td> <input  type="text" name="text1" id="text1" >  <input type="checkbox" name="cts1" value="CTSRTS">CTSRTS</input> </td>
  </tr>
  <tr></tr><tr></tr><tr></tr>
  <tr>
    <th>SERIAL PORT2 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
    <td><?php if(isset($str2)){ echo $str2;}?></td>  
	<td><input type="text" name="text2" id="text1" >  <input type="checkbox" name="cts2" value="CTSRTS">CTSRTS </td>
  </tr>    <tr></tr><tr></tr><tr></tr>

  <tr>
    <th>SERIAL PORT3 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
    <td><?php if(isset($str3)){ echo $str3;}?> </td>
	<td>  <input type="text" name="text3" id="text1" >  <input type="checkbox" name="cts2" value="CTSRTS">CTSRTS </td>
  </tr>  <tr></tr><tr></tr>
   ...
   <tr>
    ...
    <td><?php if(isset($str4)){ echo $str4;}?> </td>
	<td> <input type="text" name="text4" id="text1" > </td>
  </tr><tr></tr><tr></tr>  <tr></tr><tr></tr><tr></tr>

  <tr><th>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  PORT  NUMBER <th></tr><tr></tr><tr></tr>  <tr></tr><tr></tr><tr></tr>


  <tr>
    <th>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;SERIAL PORT1 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
    <td> <?php if(isset($str5)){ echo $str5;}?></td>  
	<td><input type="text" name="text5" id="text1" > </td>
  </tr>  <tr></tr><tr></tr><tr></tr>

  
  <tr>
    <th>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;SERIAL PORT2 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
    <td><?php if(isset($str51)){ echo $str51;}?> </td>
	<td> <input type="text" name="text51" id="text1" >
  </tr>  <tr></tr><tr></tr><tr></tr>

  
   <tr>
    <th>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;SERIAL PORT3 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
    <td><?php if(isset($str52)){ echo $str52;}?> </td>
	<td>  <input type="text" name="text52" id="text1" ></td>
  </tr>
